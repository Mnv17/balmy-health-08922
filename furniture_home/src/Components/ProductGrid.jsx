...
export function ProductGrid() {
  ...
  const filters = [
    { label: "Chair", value: "chair", image: chairImg },
    { label: "Sofa", value: "sofa", image: sofaImg },
    { label: "Table", value: "table", image: tableImg },
    { label: "Almirah", value: "almirah", image: almirahImg },
    { label: "Combos", value: "combos", image: comboImg }
  ];
  ...
  return (
    <section className="product-grid-section">
      <div className="product-grid-header">
        <h2 className="product-grid-title">THE MOST SOUGHT-AFTER & HIGHLY<br/>VALUED PRODUCT</h2>
        <p className="product-grid-subtitle">Discover the most trending products that our customers love to buy.</p>
        <div className="category-filters-grid">
          {filters.map(filter => (
            <div 
              key={filter.value} 
              className={`category-filter-card ${activeFilter === filter.value ? 'active' : ''}`}
          ...
          {filteredProducts.map(product => (
            ...
            >
              <div className="product-image-container">
                ...
                <button className="wishlist-btn" onClick={(e) => addToCart(product, e)}>
